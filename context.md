...
1. DEV-29: PageSpeed Insights cron and manual audit trigger.
2. DEV-30: fetch-based agentic browsing score.
3. DEV-31: audit UI and history.
4. DEV-32: landing page, three.js scene, feature grid, and snippet picker.
5. DEV-33: optional real-user Web Vitals.
6. DEV-34: rate limits, retention, final security review, documentation, and production release.

## Known gaps to keep in mind

- The dashboard API, overview, breakdown cards, settings, demo mode, and agent views are implemented. Audit views and the full landing page remain future tickets.
